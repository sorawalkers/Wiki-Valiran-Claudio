...
(() => {
  ...
  class ImageSlot extends HTMLElement {
    ...
    _render() {
      ...
      const editable = !!(window.omelette && window.omelette.writeFile) || !!(window._isEditor);
      ...
      // Allow data: URLs (local) and https: URLs (cloud storage)
      if (stored && stored.u && !/^data:image\//i.test(stored.u) && !/^https?:\/\//i.test(stored.u)) stored = null;
